    ...
    <main className="min-h-screen bg-slate-950 px-6 py-10 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-sm text-slate-400">Finora</p>
          ...
          <Link
            href="/"
            className="w-fit rounded-xl border border-slate-700 px-4 py-2 text-sm font-medium transition hover:bg-slate-900"
          >
            Home
          </Link>
        </header>
